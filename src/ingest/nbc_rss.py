...
os.makedirs('./data/raw/nbc/', exist_ok=True)

def fetch_feed():
    # Download and parse the feed
    return feedparser.parse('http://feeds.nbcnews.com/feeds/worldnews')
...
def fetch_full_article(url):
    try:
        ...
        print(f"Error fetching NBC article: {url} — {e}")
        return ""
...
def save_entry(entry):
    ...
    filepath = os.path.join('./data/raw/nbc/', filename)
